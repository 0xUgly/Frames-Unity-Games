...
function Unity2GameLoader() {
  ...
  useEffect(() => {
    addLog("Unity2GameLoader mounted");
    ...
    return () => {
      ...
      try {
        ...
        if (container && document.body.contains(container)) {
          ...
          const existingContainer = document.getElementById("unity2-container");
...
export default function Unity2ClientComponent() {
  return (
    <Suspense fallback={
