...
const gameName = "Base Ballz"; // Game specific info
const gameImageUrl = `${appUrl}/gameimg/baseballz1.png`; // Game specific image
const gameRoute = "/unity2"; // Game specific route
