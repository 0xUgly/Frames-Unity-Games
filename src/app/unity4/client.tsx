...
function Unity4GameLoader() {
  ...
  useEffect(() => {
    addLog("Unity4GameLoader mounted");
    ...
    return () => {
      ...
      try {
        ...
        if (container && document.body.contains(container)) {
          ...
          const existingContainer = document.getElementById("unity4-container");
