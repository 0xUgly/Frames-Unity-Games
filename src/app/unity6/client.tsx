...
function Unity6GameLoader() {
  ...
  useEffect(() => {
    addLog("Unity6GameLoader mounted");
    ...
    return () => {
      ...
      try {
        ...
        if (container && document.body.contains(container)) {
          ...
          const existingContainer = document.getElementById("unity6-container");
...
export default function Unity6ClientComponent() {
  return (
    <Suspense fallback={
