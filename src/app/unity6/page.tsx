...
const gameName = "Base Neko"; // Game specific info
const gameImageUrl = `${appUrl}/gameimg/bASE_NEKO_lg.png`; // Game specific image
const gameRoute = "/unity6"; // Game specific route
