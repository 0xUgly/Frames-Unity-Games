    ...
    if (account?.address) {
      try {
        const response = await axios.get(
          `https://thirdweb-engine.apidocumentation.com/contract/8453/0x03c4738Ee98aE44591e1A4A4F3CaB6641d95DD9a/erc721/get-owned?walletAddress=${account.address}`,
          {
            headers: {
        ...
        const result = response.data?.result?.[0]?.metadata?.name;
